...
public class Hand implements MoveableShape {
    private double centerX, centerY, length, angle;
    private int width;

    /**
     * Construct a new Hand with the specified width, center, length, and angle.
    ...
    public Hand(int width, double centerX, double centerY, double length, double angle) {
        this.width = width;
    ...
    public Hand(double centerX, double centerY) {
